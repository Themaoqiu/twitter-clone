            ...
            <div className="flex flex-row items-start gap-3">
                ...
                <div>
                    ...
                    <div className="flex flex-row items-center gap-10 mt-3">
                        ...
                        <div className="flex flex-row items-center gap-2 text-neutral-500 cursor-pointer hover:text-red-500 transition" onClick={onLike}>
                            <LikeIcon size={20} color={hasLiked ? "red" : "white"} />
